# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-01-21 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='wall_app.Access')),
            ],
        ),
        migrations.AddField(
            model_name='message',
